...
jQuery(document).ready(function() {
    ...
    */
	$('.top-content').backstretch("/static/assets/img/backgrounds/4.jpg");
    $('.section-4-container').backstretch("/static/assets/img/backgrounds/4.jpg");
    $('.section-6-container').backstretch("/static/assets/img/backgrounds/1.jpg");
